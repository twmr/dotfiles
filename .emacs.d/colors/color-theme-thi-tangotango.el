...
(defun color-theme-thi-tangotango ()
  ...
  (color-theme-install
   '(color-theme-thi-tangotango
     ...
     (magit-header ((t (:foreground "#edd400" :inherit variable-pitch))))
     (magit-diff-add ((t (:foreground "#729fcf"))))
     (magit-item-highlight ((t (:inverse-video nil))))
     (diff-header ((t (:background "gray30" :inherit variable-pitch))))
     (diff-index ((t (:foreground "#edd400" :inherit variable-pitch))))
     (diff-file-header ((t (:foreground "#eeeeec" :height 1.1 :inherit variable-pitch))))
     (diff-hunk-header ((t (:foreground "#edd400" :inherit variable-pitch))))
...
(provide 'color-theme-thi-tangotango)
